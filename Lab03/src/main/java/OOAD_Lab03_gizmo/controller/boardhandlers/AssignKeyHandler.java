package OOAD_Lab03_gizmo.controller.boardhandlers;
		...
		if(event.getEventType()==MouseEvent.MOUSE_CLICKED)
		{
			...
			if(!triggeredSelected)
			{
				if(gizmo!=null)
				{
					...
					infoLabel.setText(triggeredGizmo
							.getName()+" selected. Please select another gizmo or press a key to connect to.");
